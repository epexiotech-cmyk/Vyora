export const generalLedgerTemplate = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
<body>
    ...
    <table>
      ...
      <tbody>
        <tr class="totals">
          ...
          <td class="text-right"></td>
          <td class="text-right">{{formatCurrency this.openingBalance.amount}} {{this.openingBalance.type}}</td>
        </tr>
        {{#each this.entries}}
        <tr>
  ...
  {{#unless data.statements.length}}
  <p class="text-center">No general ledger data available for this period.</p>
  {{/unless}}
</body>
</html>
`;
