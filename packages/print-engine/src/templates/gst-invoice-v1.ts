              ...
              <table>
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-right strong">${formatCurrencyINR(data.subtotal || 0)}</td>
                        <td class="text-right strong">${formatCurrencyINR(totalCgst)}</td>
                        <td class="text-right strong">${formatCurrencyINR(totalSgst)}</td>
                        <td class="text-right strong">${formatCurrencyINR(totalIgst)}</td>
                        <td class="text-right strong">${formatCurrencyINR(data.grandTotal || 0)}</td>
                      </tr>
                  </tbody>
              </table>
              ...
              <div class="row">
                  <div class="col-50 no-border-bottom" style="padding-right: 20px;">
                    ...
                    <table class="summary-table">
                        <tr><td>Total Taxable Value</td><td class="text-right">${formatCurrencyINR(data.subtotal || 0)}</td></tr>
                        <tr><td>Total CGST</td><td class="text-right">${formatCurrencyINR(totalCgst)}</td></tr>
                        <tr><td>Total SGST</td><td class="text-right">${formatCurrencyINR(totalSgst)}</td></tr>
                        <tr><td>Total IGST</td><td class="text-right">${formatCurrencyINR(totalIgst)}</td></tr>
                    </table>
                  </div>
                  <div class="col-50 col-right no-border-bottom">
                      <table class="summary-table">
                          ...
                          <tr>
                            ...
                            <td class="text-right">${formatCurrencyINR(data.taxAmount || 0)}</td>
                          </tr>
                          <tr>
                            <td>Round Off</td>
                            <td class="text-right">${formatCurrencyINR(data.roundOffAmount || 0)}</td>
                          </tr>
                          <tr>
